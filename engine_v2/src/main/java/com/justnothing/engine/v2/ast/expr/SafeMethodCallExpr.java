...
/**
 * 安全方法调用表达式：{@code target?.methodName(args)}
 * <p>
 ...
 */
public class SafeMethodCallExpr extends ASTNode {
    ...
    private SafeMethodCallExpr(Builder builder) {
    ...
    public static class Builder extends ASTNode.Builder<Builder> {
        ...
        public SafeMethodCallExpr build() {
            return new SafeMethodCallExpr(this);
        }
    }
}
