...
public enum TokenType {
    ...
    /**
     * 完全限定名（如 java.util.Map, System.out.println）。
     * <p>
     * 由 Lexer 贪心收集 ID DOT ID DOT ID ... 序列生成。
     * 包含完整的限定路径文本，Parser 可以根据上下文决定它是类型名、字段链还是方法调用链。
     * </p>
     */
    ...
    KEYWORD_RECORD(Keywords.RECORD),
    KEYWORD_PERMITS(Keywords.PERMITS),
    ...
    KEYWORD_SEALED(Keywords.SEALED),
    ...
    KEYWORD_GOTO(Keywords.GOTO),
    KEYWORD_YIELD(Keywords.YIELD),
    ...
    private static final Set<String> KEYWORDS = new HashSet<>(
            Arrays.asList(
                    ...
                    Keywords.VOID, Keywords.AUTO, Keywords.VAR,
                    ...
                    Keywords.CLASS, Keywords.INTERFACE, Keywords.EXTENDS, Keywords.IMPLEMENTS, Keywords.PERMITS,
                    Keywords.PUBLIC, Keywords.PRIVATE, Keywords.PROTECTED,
                    Keywords.STATIC, Keywords.ABSTRACT, Keywords.NATIVE, Keywords.SYNCHRONIZED, Keywords.SEALED, Keywords.VOLATILE, Keywords.TRANSIENT, Keywords.STRICTFP,
                    Keywords.SUPER, Keywords.THIS,
                    Keywords.ASYNC, Keywords.AWAIT, Keywords.USING,
                    Keywords.PACKAGE, Keywords.ENUM, Keywords.RECORD,
                    Keywords.ASSERT, Keywords.GOTO,
                    Keywords.YIELD
            )
    );
    ...
    public static TokenType getKeywordType(String text) {
        return switch (text) {
            ...
            case Keywords.PERMITS -> KEYWORD_PERMITS;
            ...
            case Keywords.SEALED -> KEYWORD_SEALED;
            ...
            case Keywords.RECORD -> KEYWORD_RECORD;
            case Keywords.ASSERT -> KEYWORD_ASSERT;
            case Keywords.GOTO -> KEYWORD_GOTO;
            case Keywords.YIELD -> KEYWORD_YIELD;
            default -> IDENTIFIER;
        };
    }
}
