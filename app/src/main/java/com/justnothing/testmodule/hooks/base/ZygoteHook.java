...
public abstract class ZygoteHook extends XposedBasicHook<IXposedHookZygoteInit.StartupParam> {
    ...
    public class ZygoteMethodHook extends BaseMethodHook {
        ...
        public ZygoteMethodHook(String className, String methodName,
                                 Class<?>[] signature, MethodHook hook,
    ...
    protected BaseMethodHook createMethodHook(
            ...
            MethodHook hook, HookCondition<IXposedHookZygoteInit.StartupParam> shouldLoad) {
    ...
    protected BaseMethodHook createHookConstructor(String className, MethodHook hook,
                                                   Class<?>... paramTypes) {
        // 构造函数的方法名是固定的 "<init>"
    ...
    protected void hookConstructor(String className, MethodHook hook, Class<?>... paramTypes) {
