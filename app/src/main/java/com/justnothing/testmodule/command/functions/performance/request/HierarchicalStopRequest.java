...
@SerializeKeyName("perf:hierarchical:stop")
public class HierarchicalStopRequest extends PerformanceRequest {
    ...
    @Override
    public HierarchicalStopRequest fromJson(JSONObject obj) {
