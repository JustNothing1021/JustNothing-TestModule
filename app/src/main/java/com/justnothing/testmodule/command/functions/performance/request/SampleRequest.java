...
public class SampleRequest extends PerformanceRequest {
    ...
    @Override
    public SampleRequest fromJson(JSONObject obj) throws JSONException {
    ...
    @Override
    public SampleRequest fromCommandLine(String[] args) throws IllegalCommandLineArgumentException {
        return ParamParser.parse(SampleRequest.class, args);
    }
}
