...
@SerializeKeyName("MultiThreadSample")
@SubCommand("multithread")
@AutoSerializable
public class MultiThreadRequest extends PerformanceRequest {
    ...
    public MultiThreadRequest(String action) { this.action = action; }
    ...
    @Override
    public MultiThreadRequest fromJson(JSONObject obj) throws JSONException {
    ...
    @Override
    public MultiThreadRequest fromCommandLine(String[] args) throws IllegalCommandLineArgumentException {
        return ParamParser.parse(MultiThreadRequest.class, args);
    }
}
