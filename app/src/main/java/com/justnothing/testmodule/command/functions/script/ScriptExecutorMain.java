...
public class ScriptExecutorMain {
    ...
    public static class ScriptLogger extends Logger {
        @Override
    ...
    public static final ScriptLogger logger = new ScriptLogger();
    ...
    public static String runMain(CommandExecutor.CmdExecContext context) {
        ...
        try {
            ...
            runner.execute(code.toString(), context.output(), context.output());
            return "";
    ...
    private static TestInterpreter.ScriptRunner getScriptExecutor(ClassLoader cl) {
        if (cl == null) return systemScriptRunner;
        return scriptRunners.computeIfAbsent(cl, TestInterpreter.ScriptRunner::new);
    }


    public static String clearExecutorVariables(CommandExecutor.CmdExecContext context) {
