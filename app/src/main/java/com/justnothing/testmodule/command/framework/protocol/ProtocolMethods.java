 ...
 * 通过 method 名区分逻辑通道：</p>
 * <ul>
 *   <li>命令执行域：{@code cmd.*}（{@link #CMD_EXECUTE}/{@link #CMD_OUTPUT}/
 *       {@link #CMD_PROMPT}/{@link #CMD_DONE}）</li>
 *   <li>终端域：{@code term.*}（{@link #TERM_OUTPUT}/{@link #TERM_INPUT}/
 *       {@link #TERM_ENTER_RAW_MODE}/{@link #TERM_EXIT_RAW_MODE}/{@link #TERM_QUERY_SIZE}/
 *       {@link #TERM_SIZE_UPDATE}/{@link #TERM_HIGHLIGHT}）</li>
 *   <li>系统域：{@code sys.*}（{@link #SYS_HELLO}/{@link #SYS_PING}/{@link #SYS_PONG}）</li>
 * </ul>
 */
