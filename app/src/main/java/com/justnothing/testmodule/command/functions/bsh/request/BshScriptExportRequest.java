...
public class BshScriptExportRequest extends CommandRequest<BeanShellResult> {

    @CmdParam(
        name = "name",
        position = 1,
        required = true,
        description = BshTexts.PARAM_BSH_SCRIPT_EXPORT_NAME_DESC
    )
    private String name;
    ...
    @CmdParam(
        ...
        position = 2,
        required = true,
        description = BshTexts.PARAM_BSH_SCRIPT_EXPORT_EXPORTPATH_DESC
    )
