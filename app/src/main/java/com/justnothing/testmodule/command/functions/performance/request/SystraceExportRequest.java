...
@SerializeKeyName("perf:systrace:export")
public class SystraceExportRequest extends PerformanceRequest {
    ...
    @Override
    public SystraceExportRequest fromJson(JSONObject obj) {
