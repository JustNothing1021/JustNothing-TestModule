...
@SerializeKeyName("perf:trace:report")
public class TraceReportRequest extends PerformanceRequest {
    ...
    @Override
    public TraceReportRequest fromJson(JSONObject obj) throws org.json.JSONException {
