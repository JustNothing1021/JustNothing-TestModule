...
@SerializeKeyName("perf:multithread:export")
public class MultiThreadExportRequest extends PerformanceRequest {
    ...
    @Override
    public MultiThreadExportRequest fromJson(JSONObject obj) {
