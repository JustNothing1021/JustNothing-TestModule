...
@SerializeKeyName("perf:multithread:report")
public class MultiThreadReportRequest extends PerformanceRequest {
    ...
    @Override
    public MultiThreadReportRequest fromJson(JSONObject obj) throws org.json.JSONException {
