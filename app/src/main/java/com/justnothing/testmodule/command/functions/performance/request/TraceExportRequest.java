...
public class TraceExportRequest extends PerformanceRequest<PerfTraceResult> {

    @CmdParam(
        name = "id",
        position = 1,
        required = true,
        description = PerformanceTexts.PARAM_PERFORMANCE_TRACE_EXPORT_ID_DESC
    )
    private int taskId;
    ...
    @CmdParam(
        ...
        position = 2,
        required = true,
        description = PerformanceTexts.PARAM_PERFORMANCE_TRACE_EXPORT_FILEPATH_DESC
    )
