...
@SerializeKeyName("perf:hierarchical:start")
public class HierarchicalStartRequest extends PerformanceRequest {
    ...
    @Override
    public HierarchicalStartRequest fromJson(JSONObject obj) {
