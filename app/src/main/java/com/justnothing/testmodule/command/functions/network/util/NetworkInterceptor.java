package com.justnothing.testmodule.command.functions.network.util;
...
public class NetworkInterceptor {
    ...
    private static Object createMockResponse(Object request, NetworkManager.MockRule rule, ClassLoader cl) {
        try {
            ...
            assert responseBuilderClass != null;
            ...
            ReflectionUtils.callMethod(builder, "protocol",
                    Objects.requireNonNull(ClassResolver.findClass("okhttp3.Protocol", cl)).getField("HTTP_1_1").get(null));
