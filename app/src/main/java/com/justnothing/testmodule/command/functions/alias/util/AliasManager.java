package com.justnothing.testmodule.command.functions.alias.util;
...
public class AliasManager {
    ...
    private static final int MAX_ALIAS_COUNT = 128;
    ...
    private void initDefaultAliases() {
        ...
        addDefaultAlias("binfo", "bytecode info");
        addDefaultAlias("banalyze", "bytecode analyze");
        addDefaultAlias("bdecompile", "bytecode decompile");
        addDefaultAlias("minfo", "memory info");
        addDefaultAlias("mgc", "memory gc");
        addDefaultAlias("mdump", "memory dump");
        addDefaultAlias("cgraph", "class graph");
        addDefaultAlias("canalyze", "class analyze");
        addDefaultAlias("clist", "class list");
        addDefaultAlias("cinvoke", "class invoke");
        addDefaultAlias("cfield", "class field");
