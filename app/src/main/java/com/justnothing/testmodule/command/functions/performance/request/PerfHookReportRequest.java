...
@SerializeKeyName("perf:hook:report")
public class PerfHookReportRequest extends PerformanceRequest {
    ...
    @Override
    public PerfHookReportRequest fromJson(JSONObject obj) throws org.json.JSONException {
