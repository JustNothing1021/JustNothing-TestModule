...
public class TipSystem {
    ...
    public static final String NAME_JUSTNOTHING = "真的啥也不是啊 (JustNothing)";
    public static final String NAME_NONECOLDWIND = "十三怀旧 (NoneColdWind)";
    public static final String NAME_NAN = "SB1.0 (NAN)";
    public static final String NAME_BARINFXXK = "你哪个省的";
    public static final String NAME_DYD = "DYD";
    public static final String NAME_YUNMO = "云沫";
    ...
    private void initializeTips() {
        initializeSpecialTips();
        initializeDidYouKnowTips();
    ...
    private void initializeSpecialTips() {
        ...
        specialTips.add(new SpecialTipCallback(
                "今天是NAN的生日！请他吃God uses the VPN! (bushi)",
                100
        ) {
            @Override
            public boolean shouldShow() {
        ...
        tipMap.put(TipType.SPECIAL_TIP, specialTips);
    }

    private void initializeDidYouKnowTips() {
        ...
        addDidYouKnowTip(new SimpleTipCallback(
            ...
            @Override
            public String getContent() {
                int totalTips = getTipCount(TipType.DID_YOU_KNOW);
                double chance3 = 1d / (totalTips * totalTips);
                double chance4 = chance3 / totalTips;
                double chance5 = chance4 / totalTips;
                return this.content + "\n\n注:\n"+
                        "连续3次的几率：" + String.format(Locale.getDefault(), "%.6f%%", chance3 * 100d) + "\n" +
                        "连续4次的几率：" + String.format(Locale.getDefault(), "%.6f%%", chance4 * 100d) + "\n" +
                        "连续5次的几率：" + String.format(Locale.getDefault(), "%.6f%%", chance5 * 100d);
            }
        });
        ...
        List<TipCallback> didYouKnowTips = new ArrayList<>(didYouKnowTipsMap.values());
        tipMap.put(TipType.DID_YOU_KNOW, didYouKnowTips);
    }
