...
import com.justnothing.testmodule.databinding.ActivityClassQueryBinding;
...
public class ClassQueryActivity extends BaseActivity {
    ...
    private ActivityClassQueryBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityClassQueryBinding.inflate(getLayoutInflater());
    ...
    private void initViews() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle(R.string.analysis_query_info);
        }
    }
    ...
    private void displayClassInfo(ClassInfo info) {
        ...
        binding.tvMethodsTitle.setText(
            getString(R.string.analysis_methods_count_format, uniqueNames.size(), methods.size()));
