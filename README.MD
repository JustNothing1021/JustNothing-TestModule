...
>>> System.out.println("Never gonna " + new String[] {"give you up", "say goodbye"} [randint(0, 1)]);
...
### v0.4.9的TODO
 - 进一步优化 CLI 的表现, 比如命令提示, 文本编辑器啥的
 - 给所有的 CLI 命令都添加 GUI 实现

(我真的要像 AI 一样给每个英语名词都打空格吗...)
...
### Q: 为什么有三个客户端？
A: Shell处理终端，Java通过app_process执行，体验好; C++处理轻量命令 (虽然还用不了)。
